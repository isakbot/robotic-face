...
export const Hero = () => {
  return (
    <div className="bg-gradient-to-r from-primary-100 to-primary-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="text-center">
          <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
            <span className="block">The Marketplace for</span>
            <span className="block text-primary-600">Robotics Innovation</span>
          </h1>
          ...
          <div className="mt-5 max-w-md mx-auto sm:flex sm:justify-center md:mt-8">
            ...
            <div className="mt-3 rounded-md shadow sm:mt-0 sm:ml-3">
              <Button variant="outline" className="w-full flex items-center justify-center px-8 py-3 text-base font-medium rounded-md text-primary-600 bg-white hover:bg-gray-50 md:py-4 md:text-lg md:px-10">
                Browse Labs
              </Button>
            </div>
          </div>
